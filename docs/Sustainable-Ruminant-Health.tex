...
\hypersetup{
  pdftitle={Sustainable Ruminant Health},
  hidelinks,
...
\title{Sustainable Ruminant Health}
\author{true}
\date{Version compiled 29 jun 2021}
...
Miel Hostens, \url{https://www.uu.nl/staff/MMHostens}

Theo Lam, \url{https://www.uu.nl/medewerkers/TJGMLam}
...
Hostens, M. \& Lam, T. (2021). \emph{Sustainable Ruminant Health}.
Retrieved 29 January 2021 from \url{https://github.com/Bovi-analytics/SustainableRuminantHealth} .
...
{\centering \includegraphics[width=0.8\linewidth]{Sustainable-Ruminant-Health_files/figure-latex/nice-fig-1} 
